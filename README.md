...
│   └── context-summaries/ # Session handoff summaries (generated by /summarize)
...
| Persistent memory | progress.md (Active Context replaced; Session Log appended) and decisions.md (appended) |
