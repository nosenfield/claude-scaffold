...
## Formatting
1. No emojis in responses or documentation.
...
1. Systems design
2. AI coding agents + subagents
3. AI agent harnesses
4. Claude Code
...
## Response Format
1. At the end of every response, print a blank line followed by: ❤️🧡💛💚🩵
